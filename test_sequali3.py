#!/usr/bin/env python3
"""
Тестовый скрипт для проверки работы Sequali с той же командой, что и в основном коде
"""
...
def test_sequali():
    ...
    output_dir = Path("data/reports/test_output3")
    ...
    # Формируем команду точно такую же, как в основном коде
    full_name = fastq_file.name
    cmd = [
        'sequali',
        '--dir', str(output_dir),
        '--html', full_name,
